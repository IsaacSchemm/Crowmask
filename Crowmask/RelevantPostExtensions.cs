...
namespace Crowmask
{
    ...
    {
        public static async IAsyncEnumerable<Submission> GetRelevantSubmissionsAsync(this CrowmaskDbContext context, string external_activity_or_object_id)
        {
        ...
        public static async IAsyncEnumerable<Journal> GetRelevantJournalsAsync(this CrowmaskDbContext context, string external_activity_or_object_id)
        {
